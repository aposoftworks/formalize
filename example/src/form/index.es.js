...
function Input(props) {
    ...
    var onChange = useCallback(function (event) {
        ...
        if (props.onChange)
            localvalue = props.onChange(localvalue);
...
function Toggle(props) {
    ...
    return (createElement("input", __assign({}, props, { type: "checkbox", checked: componentvalue, onChange: onChange })));
}
...
function Select(props) {
    ...
    var onChange = useCallback(function (node) {
        //Get raw value
        var localvalue = node.target.value;
        //Check if the user wants to edit it
        if (props.onChange)
